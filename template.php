...
function istmat_preprocess_page(&$vars) {
  ...
  $vars['header_links'] .= '<a class="header-icon" href="mailto://'.variable_get('site_mail', ini_get('sendmail_from')).'" title="Отправить нам письмо"><img src="'.$vars['base_path'].drupal_get_path('theme', 'istmat').'/images/ico_mail.png" /></a>';
  $vars['header_links'] .= '<a class="header-icon" href="#" title="Добавить наш сайт в закладки"><img src="'.$vars['base_path'].drupal_get_path('theme', 'istmat').'/images/ico_star.png" /></a>';
  $vars['header_links'] .= '<a class="header-icon" href="'.$vars['base_path'].'sitemap" title="Посмотреть карту сайта"><img src="'.$vars['base_path'].drupal_get_path('theme', 'istmat').'/images/ico_map.png" /></a>';
  $vars['header_links'] .= '<a class="header-icon" href="'.$vars['base_path'].'rss.xml" title="Подписка на ленту новостей"><img src="'.$vars['base_path'].drupal_get_path('theme', 'istmat').'/images/ico_rss.png" /></a>';
