...
function istmat_preprocess_page(&$vars) {
  ...
  $vars['header_links'] .= '<a class="header-icon" href="#" title="Посмотреть карту сайта"><img src="'.$vars['base_path'].drupal_get_path('theme', 'istmat').'/images/ico_map.png" /></a>';
  $vars['header_links'] .= '<a class="header-icon" href="#" title="Подписка на ленту новостей"><img src="'.$vars['base_path'].drupal_get_path('theme', 'istmat').'/images/ico_rss.png" /></a>';
